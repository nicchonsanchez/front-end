...
<body>
		...
		<div class="center">
			<header>
				<div class="icons-social">
					<a href="https://facebook.com/nicchon.sanchez"><i class="fa fa-facebook" aria-hidden="true"></i></a>
					<a href="https://instagram.com/nicchon.sanchez"><i class="fa fa-instagram" aria-hidden="true"></i></a>
				</div><!--icons-social-->
				<div class="clear"></div>
				<div class="logo">
					Danki.Code
	...
	<section class="final-section">
		<div class="center">
			...
			<div class="time">
				...
				<div class="equipe-cads">
					<div class="equipe-single">
						<div class="topo-box-usuario">
							<div class="box-avatar" style="background-image: url('images/equipe-1.jpg');"></div><div class="info-usuario">
								<p style="font-weight: bold;">Nicchon Sanchez</p>
					...
					<div class="equipe-single">
						<div class="topo-box-usuario">
							<div class="box-avatar" style="background-image: url('images/equipe-2.jpg');"></div><div class="info-usuario">
								<p style="font-weight: bold;">Nicchon Sanchez</p>
								<p style="font-weight: italic;">CEO / Instrutor</p>
							</div>
						</div><!--topo-box-usuario-->
					...
					<div class="equipe-single">
						<div class="topo-box-usuario">
							<div class="box-avatar" style="background-image: url('images/equipe-3.jpg');"></div><div class="info-usuario">
								<p style="font-weight: bold;">Nicchon Sanchez</p>
								<p style="font-weight: italic;">CEO / Instrutor</p>
							</div>
						</div><!--topo-box-usuario-->
					...
					<div class="equipe-single">
						<div class="topo-box-usuario">
							<div class="box-avatar" style="background-image: url('images/equipe-4.jpg');"></div><div class="info-usuario">
								<p style="font-weight: bold;">Nicchon Sanchez</p>
								<p style="font-weight: italic;">CEO / Instrutor</p>
							</div>
						</div><!--topo-box-usuario-->
	...
	<footer>
		<p>Todos os direitos reservados | <a href="http://nicchon.com" target="_blank" rel="noopener noreferrer">nicchon.com</a></p>
	</footer>
