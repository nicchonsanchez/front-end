<?php
	...
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'teste@nicchon.com';//Trocar e-mail aqui!
		public $senha = 'Teste.151507';//Trocar senha aqui!
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'smtp.titan.email'; //SERVIDOR SMTP DA HOSPEDAGEM - br1066.hostgator.com.br - smtp.titan.email
			$this->mailer->Port = 465; //PORTA DO SMTP - 465 , 587
